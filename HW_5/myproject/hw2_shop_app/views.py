...
import logging
from hw2_shop_app.models import Client, Order, Product
...
def index(request):
    return render(request, 'hw2_shop_app/index.html')
...
def products(request):
    ...
    return render(request, 'hw2_shop_app/products.html', {'products': products})
...
def clients(request):
    ...
    return render(request, 'hw2_shop_app/clients.html', {'clients': clients})
...
def order(request, id_order: int):
    ...
    return render(request, 'hw2_shop_app/order.html', context=context)
...
def orders(request):
    ...
    return render(request, 'hw2_shop_app/orders_all.html', context=context)
...
def product(request, id_product: int):
    ...
    return render(request, "hw2_shop_app/product.html", context=context)
...
def client_products_sorted(request, id_client: int, days: int):
    ...
    return render(request, 'hw2_shop_app/client_all_products_from_orders.html',
...
def product_form(request, id_product: int):
    ...
    return render(request, "hw2_shop_app/product_form.html", context=context)
...
def choice_product_by_id(request):
    ...
    return render(request, "hw2_shop_app/choice_product_form.html", context=context)
...
def choice_products_by_client_by_days(request):
    ...
    return render(request, "hw2_shop_app/choice_product_days_form.html", context=context)
